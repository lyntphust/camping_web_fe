    ...
    <>
      ...
      >
        <div className="flex flex-col space-y-1.5 pb-6">
          <h2 className="font-semibold text-lg tracking-tight">Wildnest Bot</h2>
          <p className="text-sm text-[#6b7280] leading-3">
            Enter information to receive product suggestions
          </p>
        </div>
        ...
        <div className="flex items-center pt-0">
          <form className="flex items-center justify-center w-full space-x-2">
            <Input
              className="flex h-10 w-full rounded-md px-3 py-2 text-sm placeholder-[#6b7280]"
              placeholder="Type your message"
              type="text"
            />
            <button className="cursor-pointer px-4 py-3 text-center text-gray-100 bg-blue-600 border border-transparent dark:border-gray-700 hover:border-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-900 rounded-xl">
              Send
            </button>
          </form>
        </div>
